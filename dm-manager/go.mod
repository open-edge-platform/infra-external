...
require (
	...
	github.com/open-edge-platform/infra-core/apiv2/v2 v2.0.0-20250529092058-6f646e6f92bd
	github.com/open-edge-platform/infra-core/inventory/v2 v2.25.1-0.20250529120328-af6ea11d726d
