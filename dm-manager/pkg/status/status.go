...
var (
	...
	AMTActivationStatusInProgress = inv_status.New("AMT Activation In Progress", statusv1.StatusIndication_STATUS_INDICATION_IN_PROGRESS)
	...
	AMTDeactivationStatusInProgress = inv_status.New("AMT Deactivation In Progress", statusv1.StatusIndication_STATUS_INDICATION_IN_PROGRESS)
