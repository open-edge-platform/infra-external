...
const (
	...
	IEEE8021xConfigPATCHAuthenticationProtocolN2  IEEE8021xConfigPATCHAuthenticationProtocol = 2
...
// Defines values for ProxyConfigResponseInfoFormat.
const (
	N201 ProxyConfigResponseInfoFormat = 201
	N3   ProxyConfigResponseInfoFormat = 3
	N4   ProxyConfigResponseInfoFormat = 4
)
...
// CountProxyConfigResponse defines model for CountProxyConfigResponse.
type CountProxyConfigResponse struct {
	Data       *[]ProxyConfigResponse `json:"data,omitempty"`
	TotalCount *int                   `json:"totalCount,omitempty"`
}
...
type ProfilePATCH struct {
	...
	ProfileName                string                    `json:"profileName"`
	ProxyConfigs               *[]map[string]interface{} `json:"proxyConfigs,omitempty"`
	...
	UefiWifiSyncEnabled *bool               `json:"uefiWifiSyncEnabled,omitempty"`
...
// ProxyConfigPATCH defines model for ProxyConfigPATCH.
type ProxyConfigPATCH struct {
	// Address IP address or FQDN of the server (infoFormat will be auto-detected)
...
// ProxyConfigPOST defines model for ProxyConfigPOST.
type ProxyConfigPOST struct {
	// Address IP address or FQDN of the server (infoFormat will be auto-detected)
	Address          string `json:"address"`
	Name             string `json:"name"`
	NetworkDnsSuffix string `json:"networkDnsSuffix"`
...
// ProxyConfigResponse defines model for ProxyConfigResponse.
type ProxyConfigResponse struct {
	Address string `json:"address"`

	// InfoFormat Address format auto-detected by server (3=IPv4, 4=IPv6, 201=FQDN)
	InfoFormat       ProxyConfigResponseInfoFormat `json:"infoFormat"`
	Name             string                        `json:"name"`
	NetworkDnsSuffix string                        `json:"networkDnsSuffix"`
	Port             int                           `json:"port"`
	TenantId         string                        `json:"tenantId"`
...
// ProxyConfigResponseInfoFormat Address format auto-detected by server (3=IPv4, 4=IPv6, 201=FQDN)
type ProxyConfigResponseInfoFormat int
...
// GetAllProxyconfigsParams defines parameters for GetAllProxyconfigs.
type GetAllProxyconfigsParams struct {
	// Skip The number of items to skip before starting to collect the result set
	Skip *int `form:"$skip,omitempty" json:"$skip,omitempty"`
	...
	// Count The total number of proxy configurations
	Count *bool `form:"$count,omitempty" json:"$count,omitempty"`
}
...
// UpdateProxyconfigJSONRequestBody defines body for UpdateProxyconfig for application/json ContentType.
type UpdateProxyconfigJSONRequestBody = ProxyConfigPATCH

// CreateProxyconfigJSONRequestBody defines body for CreateProxyconfig for application/json ContentType.
type CreateProxyconfigJSONRequestBody = ProxyConfigPOST
...
type ClientInterface interface {
	...
	// GetAllProxyconfigs request
	GetAllProxyconfigs(ctx context.Context, params *GetAllProxyconfigsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateProxyconfigWithBody request with any body
	UpdateProxyconfigWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateProxyconfig(ctx context.Context, body UpdateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateProxyconfigWithBody request with any body
	CreateProxyconfigWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateProxyconfig(ctx context.Context, body CreateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteProxyconfig request
	DeleteProxyconfig(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetProxyconfig request
	GetProxyconfig(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetAllProxyconfigs(ctx context.Context, params *GetAllProxyconfigsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetAllProxyconfigsRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateProxyconfigWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateProxyconfigRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateProxyconfig(ctx context.Context, body UpdateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateProxyconfigRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateProxyconfigWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateProxyconfigRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateProxyconfig(ctx context.Context, body CreateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateProxyconfigRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteProxyconfig(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteProxyconfigRequest(c.Server, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetProxyconfig(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetProxyconfigRequest(c.Server, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetAllProxyconfigsRequest generates requests for GetAllProxyconfigs
func NewGetAllProxyconfigsRequest(server string, params *GetAllProxyconfigsParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/admin/proxyconfigs")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewUpdateProxyconfigRequest calls the generic UpdateProxyconfig builder with application/json body
func NewUpdateProxyconfigRequest(server string, body UpdateProxyconfigJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateProxyconfigRequestWithBody(server, "application/json", bodyReader)
}

// NewUpdateProxyconfigRequestWithBody generates requests for UpdateProxyconfig with any type of body
func NewUpdateProxyconfigRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewCreateProxyconfigRequest calls the generic CreateProxyconfig builder with application/json body
func NewCreateProxyconfigRequest(server string, body CreateProxyconfigJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateProxyconfigRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateProxyconfigRequestWithBody generates requests for CreateProxyconfig with any type of body
func NewCreateProxyconfigRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeleteProxyconfigRequest(server string, name string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/admin/proxyconfigs/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetProxyconfigRequest(server string, name string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetAllProxyconfigsWithResponse request
	GetAllProxyconfigsWithResponse(ctx context.Context, params *GetAllProxyconfigsParams, reqEditors ...RequestEditorFn) (*GetAllProxyconfigsResponse, error)

	// UpdateProxyconfigWithBodyWithResponse request with any body
	UpdateProxyconfigWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateProxyconfigResponse, error)

	UpdateProxyconfigWithResponse(ctx context.Context, body UpdateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateProxyconfigResponse, error)

	// CreateProxyconfigWithBodyWithResponse request with any body
	CreateProxyconfigWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateProxyconfigResponse, error)

	CreateProxyconfigWithResponse(ctx context.Context, body CreateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateProxyconfigResponse, error)

	// DeleteProxyconfigWithResponse request
	DeleteProxyconfigWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*DeleteProxyconfigResponse, error)

	// GetProxyconfigWithResponse request
	GetProxyconfigWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*GetProxyconfigResponse, error)
...
type GetAllProxyconfigsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		union json.RawMessage
...
type GetAllProxyconfigs2000 = []ProxyConfigResponse

// Status returns HTTPResponse.Status
func (r GetAllProxyconfigsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetAllProxyconfigsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r UpdateProxyconfigResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateProxyconfigResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CreateProxyconfigResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *ProxyConfigResponse
	JSON400      *APIResponse
	JSON500      *APIResponse
}

// Status returns HTTPResponse.Status
func (r CreateProxyconfigResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateProxyconfigResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetAllProxyconfigsWithResponse request returning *GetAllProxyconfigsResponse
func (c *ClientWithResponses) GetAllProxyconfigsWithResponse(ctx context.Context, params *GetAllProxyconfigsParams, reqEditors ...RequestEditorFn) (*GetAllProxyconfigsResponse, error) {
	rsp, err := c.GetAllProxyconfigs(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetAllProxyconfigsResponse(rsp)
}

// UpdateProxyconfigWithBodyWithResponse request with arbitrary body returning *UpdateProxyconfigResponse
func (c *ClientWithResponses) UpdateProxyconfigWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateProxyconfigResponse, error) {
	rsp, err := c.UpdateProxyconfigWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateProxyconfigResponse(rsp)
}

func (c *ClientWithResponses) UpdateProxyconfigWithResponse(ctx context.Context, body UpdateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateProxyconfigResponse, error) {
	rsp, err := c.UpdateProxyconfig(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateProxyconfigResponse(rsp)
...
// CreateProxyconfigWithBodyWithResponse request with arbitrary body returning *CreateProxyconfigResponse
func (c *ClientWithResponses) CreateProxyconfigWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateProxyconfigResponse, error) {
	rsp, err := c.CreateProxyconfigWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateProxyconfigResponse(rsp)
}

func (c *ClientWithResponses) CreateProxyconfigWithResponse(ctx context.Context, body CreateProxyconfigJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateProxyconfigResponse, error) {
...
func (c *ClientWithResponses) DeleteProxyconfigWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*DeleteProxyconfigResponse, error) {
	rsp, err := c.DeleteProxyconfig(ctx, name, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetProxyconfigWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*GetProxyconfigResponse, error) {
	rsp, err := c.GetProxyconfig(ctx, name, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseGetAllProxyconfigsResponse parses an HTTP response from a GetAllProxyconfigsWithResponse call
func ParseGetAllProxyconfigsResponse(rsp *http.Response) (*GetAllProxyconfigsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetAllProxyconfigsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUpdateProxyconfigResponse parses an HTTP response from a UpdateProxyconfigWithResponse call
func ParseUpdateProxyconfigResponse(rsp *http.Response) (*UpdateProxyconfigResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateProxyconfigResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseCreateProxyconfigResponse parses an HTTP response from a CreateProxyconfigWithResponse call
func ParseCreateProxyconfigResponse(rsp *http.Response) (*CreateProxyconfigResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateProxyconfigResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
