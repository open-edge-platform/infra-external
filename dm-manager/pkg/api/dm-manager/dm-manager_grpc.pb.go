...
func (c *deviceManagementClient) ReportAMTStatus(ctx context.Context, in *AMTStatusRequest, opts ...grpc.CallOption) (*AMTStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/device_management.DeviceManagement/ReportAMTStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceManagementClient) RetrieveActivationDetails(ctx context.Context, in *ActivationRequest, opts ...grpc.CallOption) (*ActivationDetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/device_management.DeviceManagement/RetrieveActivationDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceManagementClient) ReportActivationResults(ctx context.Context, in *ActivationResultRequest, opts ...grpc.CallOption) (*ActivationResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/device_management.DeviceManagement/ReportActivationResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDeviceManagementServer must be embedded to have forward compatible implementations.
...
func _DeviceManagement_ReportAMTStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/device_management.DeviceManagement/ReportAMTStatus",
	}
...
func _DeviceManagement_RetrieveActivationDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/device_management.DeviceManagement/RetrieveActivationDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeviceManagement_ReportActivationResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/device_management.DeviceManagement/ReportActivationResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
