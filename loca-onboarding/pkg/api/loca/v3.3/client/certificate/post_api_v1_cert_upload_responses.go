...
func (o *PostAPIV1CertUploadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostAPIV1CertUploadOK) GetPayload() any {
	return o.Payload
}
