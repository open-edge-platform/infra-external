...
// DtoHardwareDetail dto hardware detail
//
// swagger:model dto.HardwareDetail
type DtoHardwareDetail struct {
	...
	// interfaces
	Interfaces []*DtoNetworkSettings `json:"interfaces"`
...
// Validate validates this dto hardware detail
func (m *DtoHardwareDetail) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DtoHardwareDetail) validateCredentials(formats strfmt.Registry) error {
...
func (m *DtoHardwareDetail) validateInterfaces(formats strfmt.Registry) error {
...
func (m *DtoHardwareDetail) validateVaultCredentials(formats strfmt.Registry) error {
...
// ContextValidate validate this dto hardware detail based on the context it is used
func (m *DtoHardwareDetail) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DtoHardwareDetail) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtoHardwareDetail) contextValidateInterfaces(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtoHardwareDetail) contextValidateVaultCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtoHardwareDetail) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DtoHardwareDetail) UnmarshalBinary(b []byte) error {
	var res DtoHardwareDetail
